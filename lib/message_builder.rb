...
private
  ...
  def dependapanda_message
    ...
    if @team.security_alerts
      ...
      @all_alerts_link = "https://github.com/orgs/thames-valley-housing/security/alerts/dependabot?q=is:open+repo:#{@team.repos.join(',')}"
  ...
  def panda_presenter
    ...
    prs = prs_by_repo.map do |repo_name, prs_for_app|
      ...
      {
        repo_name:,
        repo_url: "https://github.com/thames-valley-housing/#{repo_name}/pulls?q=is:pr+is:open+label:dependencies",
